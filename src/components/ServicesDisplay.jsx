...
const services = [
  ...
  { name: "Business Automation", icon: Sliders, color: "rgba(248, 215, 232, 0.25)" },
  { name: "UI/UX Design", icon: Compass, color: "rgba(212, 175, 55, 0.25)" },
  { name: "IT Consulting", icon: HelpCircle, color: "rgba(248, 215, 232, 0.25)" }
];
        ...
        {services.map((service, index) => {
          ...
          return (
            <motion.div
              ...
              className="glass-panel glass-panel-hover p-6 rounded-2xl flex flex-col items-start text-left cursor-pointer relative group overflow-hidden select-none"
            >
              ...
              <p className="text-xs text-gray-500 font-inter font-normal mt-2 leading-relaxed opacity-0 group-hover:opacity-100 transition-all duration-300 max-h-0 group-hover:max-h-16 overflow-hidden">
                Premium enterprise grade solutions designed to automate workflows and accelerate digital scale.
              </p>
